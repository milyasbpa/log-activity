...
export interface MonthActivitySearchInputActivityMobileProps
  extends React.HTMLProps<HTMLInputElement> {
  startIcon?: React.ReactNode;
}

export const MonthActivitySearchInputActivityMobile = ({
  startIcon,
  ...otherProps
}: MonthActivitySearchInputActivityMobileProps) => {
  return (
    <div
      className={clsx(
