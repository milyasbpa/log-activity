...
export interface MonthActivityItemActivityDesktopProps {
  name?: string;
  status?: string;
  project?: string;
  time?: {
...
export const MonthActivityItemActivityDesktop = ({
  name = "",
  status = "",
  project = "",
  time = {
  ...
  onClick = () => {},
}: MonthActivityItemActivityDesktopProps) => {
  return (
    <button
      className={clsx(
    ...
    >
      ...
      >
        <p
          className={clsx(
            "text-[#000000] text-[0.875rem] font-medium text-left"
          )}
        >
          {name}
        </p>
